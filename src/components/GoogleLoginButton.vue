            ...
            <q-layout view="lHh Lpr lFf">
              <q-header class="bg-white">
                <q-toolbar class="text-black row justify-between bg-primary">
                  ...
                  <q-btn flat @click="handleCancel" color="white" rounded dense label="Cancelar"/>
                </q-toolbar>
              </q-header>
              ...
              <div class="fit row justify-center">
                <q-page-container class="registro_form">
                  ...
                  <div class="q-px-md q-pb-lg q-pt-md">
                    <q-btn no-caps color="primary" text-color="white" label="Siguiente" @click="siguiente(3)" class="full-width q-py-xs q-my-sm"></q-btn>
                    <q-btn no-caps color="white" text-color="primary" label="Volver" @click="handleCancel" class="full-width q-py-xs q-my-sm"></q-btn>
                  </div>
                </q-page-container>
              </div>
            </q-layout>
              ...
              <q-page-container>
                ...
                <div class="column items-center">
                  ...
                  <div class="q-my-lg q-px-md q-pb-lg" style="min-width: 360px">
                    <q-btn no-caps color="primary" text-color="white" label="¡Regístrate ahora!" @click="actualizar()" class=" q-py-xs full-width">
                    </q-btn>
                  </div>
                </div>
              </q-page-container>
...
export default {
  ...
  methods: {
    ...
    async handleCredentialResponse (response) {
      const res = await this.$api.post('loginByGoogle', { googleToken: response.credential })
    ...
    async actualizar () {
      ...
      if (!this.$v.form.$error && !this.$v.age.$error) {
        ...
        await this.$api.put('update_user_info_new_user/' + this.form._id, this.form).then(res => {
          if (res.success) {
            this.$q.loading.hide()
            this.$q.notify({
