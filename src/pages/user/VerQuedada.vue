...
export default {
  ...
  data () {
    return {
      participants: [
        { photo: 'https://th.bing.com/th/id/OIP.AWm5PRocqyXsiXqmOL06NwHaFj?rs=1&pid=ImgDetMain', name: 'Participante 1' },
        { photo: 'https://th.bing.com/th/id/OIP.AWm5PRocqyXsiXqmOL06NwHaFj?rs=1&pid=ImgDetMain', name: 'Participante 2' },
        { photo: 'https://th.bing.com/th/id/OIP.AWm5PRocqyXsiXqmOL06NwHaFj?rs=1&pid=ImgDetMain', name: 'Participante 3' }
      ]
    }
  },
  methods: {
