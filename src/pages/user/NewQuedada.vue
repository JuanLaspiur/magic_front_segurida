      ...
      <q-carousel class="window-height" animated v-model="slide" infinite>
        <q-carousel-slide :name="1"  class="q-pa-none">
          <q-layout view="lHh Lpr lFf">
            <q-header class="bg-white">
              <q-toolbar class="row justify-between text-grey-8">
                <q-btn flat @click="$router.go(-1)" round dense icon="arrow_back"/>
                <div @click="$router.go(-1)" class="cursor-pointer">CANCELAR</div>
              </q-toolbar>
            </q-header>

            <q-page-container>
              <div class="q-px-md q-mb-md">
                <div class="text-h6 text-bold">Detalles de evento</div>
                ...
                <q-select outlined class="q-mb-sm" label="Privacidad" v-model="form.privacy" :options="['Público', user.quedadasPriv && 'Privado', user.premium && 'Premium'].filter(Boolean)" error-message="Este campo es requerido" :error="$v.form.privacy.$error" @blur="$v.form.privacy.$touch()"/>
              </div>
        ...
        <q-carousel-slide :name="2" class="q-pa-none">
          <q-layout view="lHh Lpr lFf">
            <q-header class="bg-white">
              <q-toolbar class="row justify-between text-grey-8">
                <q-btn flat @click="slide = 1" round dense icon="arrow_back"/>
                <div @click="$router.go(-1)" class="cursor-pointer">CANCELAR</div>
              </q-toolbar>
            </q-header>

            <q-page-container>
              <q-img :src="img || edit ? quedadaImg : ''" class="bg-grey-7" style="height: 250px; width: 100%;">
