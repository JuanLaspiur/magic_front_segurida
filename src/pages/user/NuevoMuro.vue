...
>
                  ...
                  <div v-else>
                    ...
                    no-caps color="primary"
                    label="Editar perfil"
                    style="border-radius: 10px; width: 120px; height: 42px; margin-left: 0.3rem;"
                    @click="$router.push('/perfil/' + user._id)"
                  />
                  </div>
                </div>
          ...
          <q-card class="q-mb-md row justify-center items-center" style="border-radius: 10px; width: 50%; height: 110.5px;">
            <div class="row justify-center items-center" style="width: 100%;">
              ...
              <div style="width: 25%" class="columns items-center justify-center text-center q-pr-md">
                ...
                <div v-if="allQuedadas.length > 0 && allQuedadas.length < 10" class="numbers">0{{allQuedadas.length}}</div>
                <div v-else-if="allQuedadas.length > 10" class="numbers">{{allQuedadas.length}}</div>
          ...
          <q-card class="q-mb-md columns justify-center items-center q-pt-md" style="border-radius: 10px; width: 100%;">
            <div class="row justify-center items-center">
              ...
              <div style="width: 25%" class="columns items-center justify-center text-center ">
                ...
                <div v-if="allQuedadas.length > 0 && allQuedadas.length < 10" class="numbers2" style="width: 100%">0{{allQuedadas.length}}</div>
                <div v-else-if="allQuedadas.length > 10" class="numbers2" style="width: 100%">{{allQuedadas.length}}</div>
        ...
        <div class="full-width q-mt-md">
          <q-card style="border-radius: 10px; padding-top: 6px;">
            <div class="full-width q-px-lg q-py-md row justify-between items-center">
              ...
              <q-icon name="edit" class="q-mr-xs cursor-pointer" size="20px" @click="$router.push('/perfil/' + user._id)">
                <q-tooltip>
                  Editar
                </q-tooltip></q-icon>
            </div>
