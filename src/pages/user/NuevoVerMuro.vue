          ...
          >
            ...
            <div v-if="user.quedadas && calificacion === 0" class="q-px-md row">
              <div
                ...
                style="height: 15px"
              >
                <p style="font-size: 15px; font-style: italic; padding: 10px 0">
                  Karma:
                </p>
              </div>
              <q-rating
            ...
            <div class="q-px-md q-py-xs">
              <div class="row justify-between">
                <div>
                  <div class="row text-grey-8 q-pt-sm" v-if="logueado.edadPriv">
        ...
        >
          <div class="row justify-center items-center" style="width: 100%">
            ...
            >
              ...
              <div
                v-if="quedadas.length > 0 && quedadas.length < 10"
                class="numbers"
              >
                0{{ quedadas.length }}
              </div>
              <div v-else-if="quedadas.length > 10" class="numbers">
                {{ quedadas.length }}
              </div>
          ...
          <q-item
            ...
            @click="
              ;(publicidadSelec = item),
                item.totalReacciones > 0 ? (verPublicacion = true) : ''
            "
            clickable
          >
  ...
  methods: {
    ...
    async seguir (item) {
      ...
      this.$q
        .dialog({
          title: 'Confirma',
          message: `¿Seguro deseas ${text} seguir a ${
